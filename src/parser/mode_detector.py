...
class ModeDetector:
    ...
    RAID_KEYWORDS: List[str] = [
        ...
        'slothasor', 'matthias', 'keep construct', 'xera',
        'cairn', 'mursaat overseer', 'samarog', 'deimos',
        'soulless horror', 'river of souls', 'statues of ice', 'voice in the void',
        'conjured amalgamate', 'twin largos', 'qadim'
    ]

    STRIKE_KEYWORDS: List[str] = [
        'aetherblade hideout', 'junkyard', 'overlook',
        'harvest temple', 'old lion',
