...
from gw2_log_score.config import settings
...
class Logger:
    ...
    def _setup_logger(self):
        ...
        if not logger.handlers:
            ...
            max_bytes = rotation_config.max_size if hasattr(rotation_config, 'max_size') else 10485760
            backup_count = rotation_config.backup_count if hasattr(rotation_config, 'backup_count') else 5
